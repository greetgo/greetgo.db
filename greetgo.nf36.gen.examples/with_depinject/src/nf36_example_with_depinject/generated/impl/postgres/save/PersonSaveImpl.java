...
public class PersonSaveImpl implements PersonSave {
  ...
  public PersonSaveImpl(Nf36Saver saver) {
    ...
    saver.addIdName("id");
    saver.addFieldName("memory_never_be_superfluous.person_fio", "fio");
    saver.addFieldName("memory_never_be_superfluous.person_blocked", "blocked");
    saver.addFieldName("memory_never_be_superfluous.person_amount", "amount");
    saver.addFieldName("memory_never_be_superfluous.person_amount_ru", "amount_ru");
  }
