...
public class FutureCallDefTest extends AbstractWithDbTest {
  ...
  @Test
  public void last_sele_map_withMapKeyField() throws Exception {
    {
      List<String> sqls = new ArrayList<>();
  ...
  @Test
  public void last_sele_map_noMapKeyField() throws Exception {
    {
      List<String> sqls = new ArrayList<>();
  ...
  @Test
  public void last_sele_map_noMapKeyField_simpleValueType() throws Exception {
  ...
  @Test
  public void last_sele_mapList_noMapKeyField_simpleValueType() throws Exception {
  ...
  @Test
  public void last_sele_mapSet_noMapKeyField_simpleValueType() throws Exception {
  ...
  @Test
  public void last_sele_mapList_hasMapKeyField() throws Exception {
  ...
  @Test
  public void last_sele_mapSet_hasMapKeyField() throws Exception {
  ...
  private static final Tmp01 tmp01(Integer age, double val) {
    Tmp01 ret = new Tmp01();
    ret.age = age;
    ret.val = val;
    return ret;
