...
public class PreparedSqlTest {
  ...
  public void prepare_04() throws Exception {
    ...
    r.sql = "select * from ${table1} where age = #{age} and age = #{age2} or age = #{age}";
    r.paramList.add(new Param(Integer.class, "age"));
    r.paramList.add(new Param(Integer.class, "age2"));
  ...
  @Test
  public void prepare_05() throws Exception {
    conf.useNf6 = false;

    Request r = new Request();

    r.withList.add(new WithView("k_client", "x_client", "surname", "name", "age"));

    r.sql = "select * from ${table2} where age = #{age} and age = #{age2} or age = #{age}";
    r.paramList.add(new Param(Integer.class, "age"));
    r.paramList.add(new Param(Integer.class, "age2"));
