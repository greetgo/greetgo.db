...
public class Conf {
  ...
  /**
   * <p>Директория, куда генерируются исходники java-классов</p>
   * <p>
  ...
  /**
   * Префикс пакетов для моделей Change
   */
  public String changeModelPackage;
  ...
  /**
   * <p>Префикс пакетов классов модели</p>
   * <p>
  ...
  /**
   * <p>Базовый класс классов модели.</p>
   * <p>
  ...
  /**
   * <p>Интерфейс, которым реализуются все классы модели</p>
   * <p>
   * Может быть <code>null</code>
   * </p>
   */
  ...
  /**
   * Имя класса-аннотации, которое проставляется у каждого класса change-модели и связывает этот класс с таблицей в БД
   */
  public String changeModelTableNameAnnotation = null;
}
